...
folder = r"C:\Users\ADMIN\Downloads\Jumpy (1)"
# initialise pygame
mixer.init()
pygame.init()
FPS = 60
...
SCREEN = pygame.display.set_mode((400, 600), pygame.HWSURFACE | pygame.DOUBLEBUF)
selected_character = None
FONT_PATH = rf"{folder}\jumpy_tut\assets\dogicapixel.ttf"
BACKGROUND_IMAGE = rf"{folder}\jumpy_tut\assets\bg.png"
...
custom_theme = pygame_menu.themes.Theme(
    ...
    title_font_size=20,
    widget_font_size=60,
    widget_font=rf"{folder}\jumpy_tut\assets\dogicapixel.ttf"
)
...
pygame.mixer.music.load(rf"{folder}\jumpy_tut\assets\music.mp3")
pygame.mixer.music.set_volume(0.6)
pygame.mixer.music.play(-1, 0.0)
jump_fx = pygame.mixer.Sound(rf"{folder}\jumpy_tut\assets\jump.mp3")
jump_fx.set_volume(0.5)
death_fx = pygame.mixer.Sound(rf"{folder}\jumpy_tut\assets\death.mp3")
...
# load images
jumpy_image = pygame.image.load(rf"{folder}\jumpy_tut\assets\jump.png").convert_alpha()
bg_image = pygame.image.load(rf"{folder}\jumpy_tut\assets\bg.png").convert_alpha()
platform_image = pygame.image.load(rf"{folder}\jumpy_tut\assets\wood.png").convert_alpha()
# bird spritesheet
bird_sheet_img = pygame.image.load(rf"{folder}\jumpy_tut\assets\bird.png").convert_alpha()
...
class Player():
    def __init__(self, x, y,jumpy_image ):
        backgroundfile = pygame.image.load(jumpy_image)
        self.image = pygame.transform.scale(backgroundfile, (45, 45))
        self.width = 35
        self.height = 60
...
def main_menu():
    menu = pygame_menu.Menu('Main_menu', SCREEN_WIDTH, SCREEN_HEIGHT, theme=custom_theme)
    menu.add.button('OPTION', choose_character_menu)
...
def choose_character_menu():
    ...
    menu = pygame_menu.Menu('Choose your character', SCREEN_WIDTH, SCREEN_HEIGHT, theme=custom_menu)
    characters = [
        (rf"{folder}\jumpy_tut\assets\character1.png", 'Character 1', 1),
        (rf"{folder}\jumpy_tut\assets\character2.png", 'Character 2', 2),
        (rf"{folder}\jumpy_tut\assets\character3.png", 'Character 3', 3),
        (rf"{folder}\jumpy_tut\assets\character4.png", 'Character 4', 4),
        (rf"{folder}\jumpy_tut\assets\character5.png", 'Character 5', 5),
        (rf"{folder}\jumpy_tut\assets\character6.png", 'Character 6', 6)
    ]
    # Thêm nút vào menu
...
def start_game_logic(selected_character):
    if selected_character is not None:
        ...
        # if selected_character in character_classes:
        #     character_class = character_classes[selected_character]
        #     bg = BACKGROUND_IMAGE
        #     character = character_class
        #     start_game(character)
def run_game(game_over, bg_scroll, platform, score, high_score, fade_counter, jumpy):
    run = True
    while run:
        clock.tick(FPS)
        if game_over == False:
